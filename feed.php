...
$sql_usuario_logado = "SELECT * FROM usuarios WHERE id = '$usuario_id'";
$resultado_usuario_logado = mysqli_query($conexao, $sql_usuario_logado);
$usuario_logado = mysqli_fetch_assoc($resultado_usuario_logado);

if (isset($_GET['busca'])) {
    $busca = $_GET['busca'];
}

$sql = "SELECT artigos.*, usuarios.nome, usuarios.curso, usuarios.avatar
        FROM artigos
    ...
    <main class="layout">
        ...
        <aside class="sidebar-left">
            <section class="profile-card">
                <?php if (!empty($usuario_logado['avatar'])) { ?>
                    <img class="avatar" src="uploads/<?php echo $usuario_logado['avatar']; ?>">
                <?php } else { ?>
                    <div class="avatar">
                    ...
                    <div class="post-header">
                        <?php if (!empty($artigo['avatar'])) { ?>
                            <img class="avatar small"
                                src="uploads/<?php echo $artigo['avatar']; ?>">
                        <?php } else { ?>
